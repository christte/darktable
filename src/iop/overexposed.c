...
static void _transform_image_colorspace(const float *const img_in, float *const img_out,
                                        const dt_iop_roi_t *const roi_in)
{
  ...
  if(xform_rgb2rgb) cmsDoTransform(xform_rgb2rgb, img_in, img_out, roi_in->width * roi_in->height);
