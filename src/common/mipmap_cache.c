                    ...
                    const dt_mipmap_size_t size)
{
  *iscale = 1.0f;
  ...
  if(res)
  {
    ...
    res = dt_imageio_export_with_flags(imgid, "unused", &format, (dt_imageio_module_data_t *)&dat, TRUE, FALSE,
                                       FALSE, FALSE, TRUE, NULL, FALSE, DT_COLORSPACE_NONE, NULL, DT_INTENT_LAST,
                                       NULL, NULL, 1, 1);
    if(!res)
    {
